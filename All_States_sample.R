...
gdc%>%
  ...
  theme(axis.text.x = element_text(angle=45, vjust=1, hjust=1))+ #slant x axis labels
  xlab("State")+
...
gdc %>%
  filter(state == "AL")%>%
  ggplot()+
  geom_line(aes(x = year, y = pregnancyratelt15, color = "Women 14 or younger"))+
  geom_line(aes(x = year, y = pregnancyrate1517, color = "Women Aged 15 to 17"))+
  geom_line(aes(x = year, y = pregnancyrate1819, color = "Women Aged 18 to 19"))+
  geom_line(aes(x = year, y = pregnancyratelt20, color = "Women Aged 20 or younger"))+
  geom_line(aes(x = year, y = pregnancyrate1819, color = "Women Aged 20 to 24"))+
  geom_line(aes(x = year, y = pregnancyrate2529, color = "Women Aged 25 to 29"))+
  geom_line(aes(x = year, y = pregnancyrate3034, color = "Women Aged 30 to 34"))+
  geom_line(aes(x = year, y = pregnancyrate3539, color = "Women Aged 35 to 39"))+
  geom_line(aes(x = year, y = pregnancyrate40plus, color = "Women Aged 40 or older")) + 
  ylab("Pregnancy Rate (%)")+
  ggtitle("Alabama: Pregnancy Rate vs. Year") 
